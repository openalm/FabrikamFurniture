		...
		<div>
			<div class="body">
				...
				<ul id="featured">
					<li>
						<div>
							<img src="images/living-room.jpg" alt="Img"> <a href="index.php"></a>
						</div>
						<div class="details">
							<h4>Living Room</h4>
							<p>
					...
					<li class="bedroom">
						<div>
							<img src="images/bedroom.jpg" alt="Img"> <a href="index.php"></a>
						</div>
						<div class="details">
							<h4>Bedroom</h4>
							<p>
					...
					<li class="kitchen">
						<div>
							<img src="images/kitchen.jpg" alt="Img"> <a href="index.php"></a>
						</div>
						<div class="details">
							<h4>Kitchen</h4>
							<p>
